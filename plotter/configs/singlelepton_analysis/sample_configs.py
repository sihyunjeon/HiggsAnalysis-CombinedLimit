sample_configs = {
    ...
    "background" : {
        ...
        "Top__space__Pair__plus__X" : {
            "process" : ["TTLJ_powheg", "TTLL_powheg", "TTJJ_powheg", "ttWToLNu", "ttWToQQ", "ttZToLLNuNu", "ttZToQQ"],
        },
        "Single__space__Top" : {
...
try:
    ...
    sample_configs["signal"]["MN__equal__700GeV"]["color"] = ROOT.kGray+3
    ...
    sample_configs["background"]["Single__space__V"]["color"] = ROOT.kAzure-3
    sample_configs["background"]["VV__plus__X"]["color"] = ROOT.kTeal+10
    sample_configs["background"]["Top__space__Pair__plus__X"]["color"] = ROOT.kRed-4
