...
# To display the mean and ROOTMS:   SetOptStat('mr')
...
ROOT.gStyle.SetTitleSize(0.06, 'XYZ') # 0.06 #FIXME
...
ROOT.gStyle.SetLabelSize(0.05, 'XYZ') # 0.05 #FIXME
